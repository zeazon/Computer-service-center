...
public interface ProductDAO {
	...
	public List<Product> selectByCriteria(String typeID, String brandID, String modelID, String description, Integer rows, Integer page, String orderBy, String orderType) throws Exception;
