...
public interface ServiceOrderService {
	...
	public List<ServiceOrder> selectByCriteria(String name, String surname, String startDate, String endDate, String type, String serialNo, Integer rows, Integer page, String orderBy, String orderType);
