...
public interface OutsiteServiceService {
	...
	public Map<String, Object> selectByCriteria(String name, String surname, String date, String type, String serialNo, String refOutsiteJobID, String outsiteCompanyID, String transportCompanyID, String status, Integer rows, Integer page, String orderBy, String orderType);
