...
public interface OutsiteServiceDAO {
	...
	public List<OutsiteService> selectSentOSByCriteria(String name, String date, String type, String serialNo, String refOutsiteJobID, String outsiteCompanyID, String transportComapnyID, Integer rows, Integer page, String orderBy, String orderType) throws Exception;
