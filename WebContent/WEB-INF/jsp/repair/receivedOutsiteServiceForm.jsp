							...
							<fieldset style="background-color:#eeeeee; margin: 0 10px 0 10px; ">
								...
								<table width="100%">
									...
									<tr>
										...
										<td colspan="5" align="left"><div class="rowElem"><span id="problem" >${form.serviceOrder.problem}&nbsp;</span></div></td>
									</tr>
									<tr>
...
*/	
	...
	$('#receivedDate').calendarsPicker($.extend({calendar: $.calendars.instance('thai','th')}));
