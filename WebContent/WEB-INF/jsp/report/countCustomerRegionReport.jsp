...
<table width="100%">
	<tr>
		<td>
			<form:form commandName="searchForm" id="searchForm" class="jqtransform" action="countCustomerRegionReport.html?do=printReport" method="post" target="_blank">
				<table>
					<tr>
					...
					<tr>
						<td><label><fmt:message key="countCustomerRegion.numRow" />:</label></td>
						<td><div class="rowElem"><form:input path="numRow" cssClass="required number" size="4"/></div></td>
					</tr>
					<tr>
